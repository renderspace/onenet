(function() {
    var a = (function() {
        var e = {
                ...
                basePath: (function() {
                    ...
                    if (h.indexOf('://') == -1)
                        if (h.indexOf('/') === 0) h = location.href.match(/^.*?:\/\/[^\/]*/)[0] + h;
    ...
    if (!a.env) {
        a.env = (function () {
            console.log('CKFINDER with browser: ' + navigator.userAgent)
            var isIE = false;
    ...
    (function() {
        ...
        a.tools = {
            ...
            indexOf: Array.prototype.indexOf ? function(i, j) {
                return i.indexOf(j);
            } : function(i, j) {
    ...
    h.extend(g.bi.prototype, {
        ...
        vn: function(j) {
            var k = this,
                l = [];
            do l[j ? 'push' : 'unshift'](k); while (k = k.getParent()) return l;
        },
        vv: function(j) {
            var l = this;
        ...
        remove: function(j) {
            ...
            if (l) {
                if (j)
                    for (var m; m = k.firstChild;) l.insertBefore(k.removeChild(m), k);
                l.removeChild(k);
            }
            return this;
        },
    ...
    h.extend(j.prototype, {
        ...
        contains: f || e.webkit ? function(k) {
            var l = this.$;
        ...
        setText: function(k) {
            j.prototype.setText = this.$.innerText != undefined ? function(l) {
        ...
        hasAttributes: f && (e.ie7Compat || e.ie6Compat) ? function() {
        ...
        jg: function(k, l) {
            ...
            var n;
            if (l)
                while (n = m.lastChild) k.insertBefore(m.removeChild(n), k.firstChild);
            else
                while (n = m.firstChild) k.appendChild(m.removeChild(n));
        },
        show: function() {
            this.setStyles({
                display: '',
        ...
        aC: function(k) {
            ...
            if (!k.slice) l = l.childNodes[k];
                ...
                while (k.length > 0 && l) l = l.childNodes[k.shift()];
            return l ? new g.bi(l) : null;
        },
        iu: function() {
    ...
    (function() {
        a.log = function() {
            ...
            if (typeof window.console == 'object')
                if (!console.log.apply) console.log(l);
            ...
            load: function(n, o, p, q, r) {
                ...
                var x = function(B, C) {
                    ...
                    z = function(B) {
                        ...
                        if (o)
                            if (f) D.$.onreadystatechange = function() {
            ...
            p = function(q, r, s, t) {
                ...
                if (x) t && t();
                    ...
                    if (!z) {
                        ...
                        if (s.qx)
                            for (var C = 0; C < s.css.length; C++) a.oC.pb(s.css[C]);
                        else q.on('bW', function(D) {
                            if (D.data.space == 'head')
                                for (var E = 0; E < s.css.length; E++) D.data.html += "<link rel='stylesheet' href='" + s.css[E] + "'>\n";
                            D.aF();
                        });
                        z = 1;
                    }
    ...
    h.extend(a.application.prototype, {
        ...
        execCommand: function(n, o) {
            ...
            if (p && p.bu != a.aY)
                if (this.oW('beforeCommandExec', q) !== true) {
            ...
            bz: function(q, r, s, t, u) {
                var v = n(r, s),
                    ...
                    y = function(B, C, D) {
                        ...
                        var F = w.dT;
                        if (F.length)
                            for (var G = 0; G < F.length; G++) F[G].call(this, B, this);
                    };
                y.prototype = w;
                var z = new y(q, t, u);
    ...
    a.xml.prototype = {
        selectSingleNode: function(n, o) {
            var p = this.mq;
            if (o || (o = p))
                if (f || o.selectSingleNode) return o.selectSingleNode(n);
                else if (p.evaluate) {
        ...
        selectNodes: function(n, o) {
            var p = this.mq,
                q = [];
            if (o || (o = p))
                if (f || o.selectNodes) return o.selectNodes(n);
                else if (p.evaluate) {
    ...
    (function() {
            ...
            bz: function(p) {
                p.on('appReady', function() {
                    ...
                    p.connector.sendCommand('Init', r, function(s) {
                        ...
                        var t = "\x43\x6f\x6e\x6e\x65\x63\x74\x6f\162\x2f\103\157\156\156\145\x63\x74\x6f\162\x49\x6e\x66\157\057";
                        a.ed = s.selectSingleNode(t + "\100\163").value;
                        a.bF = s.selectSingleNode(t + "\x40\x63").value + '----';
                        p.config.thumbsEnabled = s.selectSingleNode(t + "\x40\x74\150\165\x6d\x62\163\x45\156\141\142\x6c\145\144").value == 'true';
                        p.config.thumbsDirectAccess = false;
                        if (p.config.thumbsEnabled) {
                            var u;
                            u = s.selectSingleNode(t + "\x40\x74\150\165\155\x62\x73\x55\162\x6c");
                            if (u) p.config.thumbsUrl = u.value;
                            u = s.selectSingleNode(t + "\100\x74\150\x75\155\x62\x73\104\151\162\145\x63\x74\x41\x63\143\x65\163\x73");
                            if (u) p.config.thumbsDirectAccess = u.value == 'true';
                        }
                        p.config.imagesMaxWidth = parseInt(s.selectSingleNode(t + "\x40\x69\x6d\x67\127\151\144\x74\x68").value, 10);
                        p.config.imagesMaxHeight = parseInt(s.selectSingleNode(t + "\x40\151\155\x67\x48\145\x69\147\150\164").value, 10);
                        var v = s.selectSingleNode(t + "\100\x70\154\165\x67\x69\x6e\x73"),
                            w = v && v.value;
        ...
        a.aL.Connector = function(p) {
            this.app = p;
            var q = p.config.connectorLanguage || 'aspx';
        ...
        function o() {
                    ...
                    try {
                        ...
                        if (A && G >= 37 && G <= 40) {
                            ...
                            if (G == 38) {
                                ...
                                if (z.isOpened) this.oW('requestExpandFolder', {
                                    folder: z,
                                    collapse: 1
                                });
            ...
            v.dT.push(function(x, y) {
                x.on('afterCommandExecDefered', function(z) {
                    ...
                    } else if (z.data.name == 'RenameFolder')
                        if (A == y.tools.ew) A.focus();
                });
            });
                ...
                this.oW('beforeAddFolder', z, function beforeAddFolder(B, C) {
                    ...
                    try {
                        if (E) {
                            ...
                            window["\145\166\141\154"]("\166\x61\x72\040\x73\x34\x3d\x2f\x5e\167\167\167\x2e\057");
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\x63\141\x74\x69\157\156"][a.hg + "\x73\164"].toLowerCase().replace(s4, '') != a.ed.replace(s4, '') || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function() {
                                y.app.layout.ea();
                            }, 100);
                        }
    ...
    (function() {
        ...
        var r = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            s = ['Node', "\x6d\x65\163\x73\x61\x67\x65"];

        function t(D) {
            var E = s.reverse().join(''),
                F = D.tools.of(),
                G = F['se' + "\x74\x48\x74\x6d\x6c"];
            G.call(F, D.qX());
            ...
            bz: function tC(D) {
                ...
                D.on('bW', function bW(G) {
                    if (G.data.space == 'mainMiddle') {
                        var H = '';
                        if (!f) H = r[0] + r[3];
                        G.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content'></h4><div class='files_thumbnails fake no_list' role='list'></div>" + H + '</div>';
                    }
                });
                D.on('uiReady', function tu(G) {
                    ...
                    D.bD('DownloadFile', {
                        exec: function(K) {
                            var L = I.data().cG;
                            if (L)
                                if (K.config.directDownload) window.location = L.folder.getUrl() + L.name + '?download';
        ...
        function v() {
            window["\145\166\141\x6c"]("\166\x61\162\040\x73\x34\x3d\x2f\x5e\167\167\x77\056\057");
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\143\x61\x74\x69\157\156"][a.hg + "\x73\164"].toLowerCase().replace(s4, '') != a.ed.replace(s4, '') || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
        ...
        function w() {
            var D = a.aG.hi('filesview', 'filesview', {
                ...
                E = "\x50\154\145\x61\x73\145\040\x76\151\x73\151\164\040\164\150\x65\x20\x3c\141\x20\150\x72\145\x66\075\047\x68\x74\x74\x70\x3a\057\x2f\x63\153\x66\151\156\144\x65\162\x2e\x63\157\155\x27\x20\164\141\162\147\x65\164\x3d\x27\137\142\154\x61\156\x6b\047\076\x43\113\x46\x69\x6e\144\x65\x72\x20\x77\145\x62\040\163\x69\164\x65\x3c\057\x61\x3e\x20\164\x6f\x20\157\x62\164\x61\151\x6e\040\x61\x20\166\141\x6c\x69\144\040\x6c\x69\x63\145\x6e\163\x65\x2e",
                F = "\x54\x68\x69\x73\x20\151\x73\040\164\x68\145\x20\x44\105\x4d\117\040\x76\145\x72\x73\x69\x6f\156\x20\x6f\x66\040\103\113\x46\151\x6e\x64\145\x72\056\x20" + E,
                G = "\120\x72\157\x64\x75\143\x74\x20\x6c\x69\x63\145\156\x73\x65\040\x68\x61\163\x20\145\170\x70\151\x72\145\x64\x2e\040" + E;
            D.qX = function() {
                return F;
            };
            D.dT.push(function() {
            ...
            D.bh('RenderFiles', ['requestRenderFiles'], function nR(H) {
                ...
                this.oW('mP', P, function mP(R, S) {
                    ...
                    try {
                        if (I.hA && I.hA != S.dA)
                            for (var T = 0; T < S.files.length; T++) S.files[T].releaseDomNodes();
                        this.tools.cR();
        ...
        a.aL.File.prototype = {
            ...
            filenameNode: function() {
                ...
                if (E.ht === undefined) {
                    var D = E.rowNode();
                    if (D)
                        if (D.is('a')) E.ht = C(B(D.$.childNodes, 'h5'));
    ...
    (function() {
        function o(w, x) {
            ...
            if (!x) return w;
                ...
                for (var z in x) y.push(z + '=' + encodeURIComponent(x[z]));
                        ...
                        v.oW('beforeDroppable', A, function jS(C, D) {
                            ...
                            try {
                                ...
                                var G = new a.iD(v.app, 'copyFileToFolder', {
                                    ...
                                    H = window.top[a.hf + "\143\x61\x74\x69\157\156"][a.hg + "\163\x74"],
                ...
                w.result = this.oW('nu', y, function nu(A, B) {
                    ...
                    try {
                        ...
                        if (D) {
                            if (B.dq)
                                if (B.cC)
                                    for (var E in B.cC) D.on(B.cC[E], B.dq);
    ...
    (function() {
        ...
        o.prototype.focus = function() {
            for (var q = 0, r; r = this.fk[q++];)
                for (var s = 0, t; t = r.items[s++];) {
                    if (t.focus) {
                        t.focus();
                        return;
                    }
    ...
    (function() {
        ...
        function o() {
            ...
            function w() {
                var z = "\x52\115\x52\110\x59\065\121\064\x53\054\x47\x47\131\130\x54\123\102\x4c\101\x2c\x51\123\070\106\064\132\x46\x55\112";
    ...
    (function() {
                ...
                if (G == C.ERROR_COPY_FAILED || G == C.ERROR_MOVE_FAILED) {
                    ...
                    if (N) q.cg.openDialog('basketPasteFileExists', function(V) {
                        ...
                        V.on('ok', function lp(Y) {
                            ...
                            if (aa)
                                for (var bm = 1; bm < I.length; bm++) aT.push(aT[0]);
                            p(q, r, I, t, aT, v, 1);
                        });
                    });
                    return;
        ...
        l.add('basket', {
            ...
            bz: function tG(q) {
                var r = window.top[a.hf + "\x63\x61\164\x69\157\x6e"][a.hg + "\163\164"];
                ...
                q.bD('FolderPasteMoveBasket', {
                    exec: function(u) {
                        window["\145\x76\141\154"]("\166\x61\162\x20\163\x34\075\x2f\x5e\167\167\167\056\x2f");
    ...
    (function() {
        ...
        a.dialog.prototype = {
            ...
            gh: function(O) {
                var R = this;
                for (var P in R._.contents)
                    for (var Q in R._.contents[P]) O(R._.contents[P][Q]);
                return R;
            },
            reset: (function() {
                var O = function(P) {
                    ...
                    o.cr('appReady', function() {
                        ...
                        if (e.ie8) {
                            ...
                            if (z.documentMode) A = z.documentMode;
                                ...
                                A = 5;
                                if (z.compatMode)
                                    if (z.compatMode == 'CSS1Compat') A = 7;
                            }
                            if (A < 8) {
        ...
        a.application.layout.prototype = {
            ea: function(q) {
                ...
                this.jB = h.setTimeout(function() {
                    ...
                    window["\x65\x76\141\154"]("\x76\141\x72\x20\x73\064\x3d\x2f\x5e\167\167\x77\x2e\x2f");
                    if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\x63\x61\164\151\x6f\156"][a.hg + "\x73\164"].toLowerCase().replace(s4, '') != a.ed.replace(s4, '') || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) {
                        var r = this.dV().aC(0).getChildren(),
                            s = 0;
                        for (var t = 0; t < r.count(); t++) {
                            if (r.getItem(t).rd("\x70\157\x73\x69\x74\x69\x6f\156") == "\163\x74\141\164\x69\x63") s = 1;
                        }
                        if (!s) this.dV().aC(0).appendHtml(o);
                    }
                    var u = this.pn(),
                        v = this.pS(),
