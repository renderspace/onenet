...
<div class="page-and-module-settings">
    <section class="module form-horizontal">
        ...
        <div class="form-group">
             <div class="col-sm-offset-3 col-sm-9">
                ...
                <asp:LinkButton ID="ButtonSave" runat="server" Text="Save" onclick="ButtonSave_Click" CssClass="btn btn-success" />
                <asp:LinkButton ID="ButtonSaveAndClose" runat="server" onclick="ButtonSaveAndClose_Click" CssClass="btn btn-success" />
             </div>
        </div>
     </section>
    </div>