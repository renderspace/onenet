<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkBrowser.aspx.cs" Inherits="OneMainWeb.LinkBrowser" %>
...
<body>
    <form id="form1" runat="server">
        <div class="fmPopUp">
            <one:FileManager runat="server" ID="filemng" ShowSelectLink="true" ContainerControlType="fck" />    
        </div>
    </form>
</body>
</html>
