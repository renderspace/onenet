<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/OneMain.Master" AutoEventWireup="true" CodeBehind="Forms.aspx.cs" Inherits="One.Net.Forms.adm.Forms" Title="One.NET Forms"  EnableEventValidation="false" %>
                 ...
                 <div class="col-md-3">
                     <section class="module tall">
                            <asp:Panel ID="plhAddForm" runat="server" CssClass="form-group validationGroup">
		                        <asp:TextBox formnovalidate="formnovalidate" ID="txtAddForm" runat="server" placeholder="new form name"  CssClass="required"/>
                        ...
                        <div class="adminSection form-horizontal">
		                    <asp:PlaceHolder ID="plhUpdateForm" runat="server">
                                <div class="validationGroup">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox formnovalidate="formnovalidate"  ID="txtFormName" runat="server" CssClass="form-control required" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox formnovalidate="formnovalidate" type="email" runat="server" ID="txtSendTo" CssClass="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox formnovalidate="formnovalidate" type="url" ID="InputCompletionRedirect" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9">
		                                    <asp:button formnovalidate="formnovalidate"	id="cmdUpdateForm" Runat="server" CssClass="btn btn-success causesValidation" Text="Save form" OnClick="cmdUpdateForm_Click" />
                                        </div>
		                            </div>
                                </div>
		                    </asp:PlaceHolder>
		                    ...
		                    <asp:PlaceHolder ID="plhUpdateSection" runat="server">
                                <div class="validationGroup">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <asp:TextBox formnovalidate="formnovalidate"   runat="server" ID="txtSectionName"  CssClass="form-control required" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Description</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <asp:TextBox formnovalidate="formnovalidate"  ID="InputSectionOnClientClick" runat="server"   CssClass="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9">
		                                    <asp:button formnovalidate="formnovalidate"	id="cmdUpdateSection" Runat="server"  Text="Save" OnClick="cmdUpdateSection_Click" CssClass="causesValidation btn btn-success" />			            
		                                <asp:button formnovalidate="formnovalidate"	id="cmdDeleteSection" Runat="server"  Text="Delete" OnClick="cmdDeleteSection_Click" CssClass="btn btn-danger" />			            		                    
		                                <asp:button formnovalidate="formnovalidate"	id="cmdUnDeleteSection" Runat="server"  Text="Undelete" OnClick="cmdUnDeleteSection_Click" CssClass="btn btn-default" />			            		                    		                    
                                        </div>
		                            </div>
                                </div>
		                    </asp:PlaceHolder>
		                    <asp:PlaceHolder ID="plhUpdateQuestion" runat="server">
                                <div class="validationGroup">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
		                                <asp:TextBox formnovalidate="formnovalidate" id="txtQuestionText" runat="server" CssClass="form-control required" />
                                        </div>
                                     </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9">
		                                    <asp:LinkButton formnovalidate="formnovalidate"	id="cmdDeleteQuestion" Runat="server" Text="Delete" OnClick="cmdDeleteQuestion_Click" CssClass="btn btn-default" />			            		                    		                    
		                                    <asp:LinkButton formnovalidate="formnovalidate"	id="cmdUnDeleteQuestion" Runat="server" Text="Undelete" OnClick="cmdUnDeleteQuestion_Click" CssClass="btn btn-danger" />			            		                    		                    		                    
		                                    <asp:LinkButton formnovalidate="formnovalidate"	id="cmdUpdateQuestion" Runat="server" Text="Save" OnClick="cmdUpdateQuestion_Click" CssClass="causesValidation btn btn-success" />	
		                                </div>
		                            </div>
                                </div>
		                    </asp:PlaceHolder>
                            <div class="form-group" id="overallButtons" runat="server">
                                 <div class="col-sm-offset-3 col-sm-9">
                                    ...
                                    <asp:LinkButton formnovalidate="formnovalidate" ID="cmdSaveForm" OnClick="cmdSaveForm_Click" runat="server" Text="Save" CssClass="btn btn-success" />
                                    <asp:LinkButton formnovalidate="formnovalidate" ID="cmdSaveFormAndClose" OnClick="cmdSaveFormAndClose_Click" runat="server" Text="Save and close" CssClass="btn btn-success" />
                                 </div>
                            </div>    
                        </div>
                    </div>
